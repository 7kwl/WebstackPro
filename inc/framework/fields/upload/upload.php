...
if( ! class_exists( 'CSF_Field_upload' ) ) {
  class CSF_Field_upload extends CSF_Fields {
    ...
    public function render() {
      ...
      // iowen.cn --------------
      echo '<div class="csf-field-media"><div class="csf--preview'. $hidden .'">';
      echo '<div class="csf-image-preview"><a href="#" class="csf--remove fa fa-times"></a><img src="'. $this->value .'" class="csf--src" /></div>';
      echo '</div></div>';
      // -----------------------
